...
// [[COMPILER: Clang REGEX: .*error: no matching constructor for initialization
// of 'tuples::tagged_tuple<tags::Int>'.  tuples::tagged_tuple<tags::Int>
// dummy;.*]]
...
// [[COMPILER: Clang REGEX: .*error: no viable overloaded '='.*candidate
